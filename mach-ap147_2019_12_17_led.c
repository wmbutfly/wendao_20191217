...
#define AP147_GPIO_LED_S0	15
#define AP147_GPIO_LED_S1	16
#define AP147_GPIO_LED_S2	11
#define AP147_GPIO_LED_S3	13

#define AP147_GPIO_LED_WAN	4
#define AP147_GPIO_LED_LAN3	14
#define AP147_GPIO_LED_WLAN_2G	12

#define AP147_GPIO_BIN_RESET	17
...
static struct gpio_led ap147_leds_gpio[] __initdata = {
	{
		...
		.name		= "ap147:green:S0",
		.gpio		= AP147_GPIO_LED_S0,
		.active_low	= 1,
	}, {
		.name		= "ap147:green:S1",
		.gpio		= AP147_GPIO_LED_S1,
		.active_low	= 1,
	}, {
		.name		= "ap147:green:S2",
		.gpio		= AP147_GPIO_LED_S2,
		.active_low	= 1,
	}, {
